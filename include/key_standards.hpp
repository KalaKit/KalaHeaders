...
namespace KalaHeaders::KalaKeyStandards
{
	...
	{{
		{scast<u32>(KeyboardButton::K_A), 0x0061, "a"},
		{scast<u32>(KeyboardButton::K_B), 0x0062, "b"},
		{scast<u32>(KeyboardButton::K_C), 0x0063, "c"},
		{scast<u32>(KeyboardButton::K_D), 0x0064, "d"},
		{scast<u32>(KeyboardButton::K_E), 0x0065, "e"},
		{scast<u32>(KeyboardButton::K_F), 0x0066, "f"},
		{scast<u32>(KeyboardButton::K_G), 0x0067, "g"},
		{scast<u32>(KeyboardButton::K_H), 0x0068, "h"},
		{scast<u32>(KeyboardButton::K_I), 0x0069, "i"},
		{scast<u32>(KeyboardButton::K_J), 0x006A, "j"},
		{scast<u32>(KeyboardButton::K_K), 0x006B, "k"},
		{scast<u32>(KeyboardButton::K_L), 0x006C, "l"},
		{scast<u32>(KeyboardButton::K_M), 0x006D, "m"},
		{scast<u32>(KeyboardButton::K_N), 0x006E, "n"},
		{scast<u32>(KeyboardButton::K_O), 0x006F, "o"},
		{scast<u32>(KeyboardButton::K_P), 0x0070, "p"},
		{scast<u32>(KeyboardButton::K_Q), 0x0071, "q"},
		{scast<u32>(KeyboardButton::K_R), 0x0072, "r"},
		{scast<u32>(KeyboardButton::K_S), 0x0073, "s"},
		{scast<u32>(KeyboardButton::K_T), 0x0074, "t"},
		{scast<u32>(KeyboardButton::K_U), 0x0075, "u"},
		{scast<u32>(KeyboardButton::K_V), 0x0076, "v"},
		{scast<u32>(KeyboardButton::K_W), 0x0077, "w"},
		{scast<u32>(KeyboardButton::K_X), 0x0078, "x"},
		...
		{scast<u32>(KeyboardButton::K_SPACE), 0x0020, "space"},
